...
export const Layout: React.FC = () => {
  ...
  const mobileNavItems = navItems.filter((item) => (isUndergrad ? ['/university','/practice','/exam','/ai','/university-analytics','/profile'] : ['/','/learn','/practice','/ai','/profile']).includes(item.path));
